#!/bin/bash
################################################################################
# GroupDocs.Signature.Mcp — Docker-Compose Integration Test Runner
#
...
TEST_PROJECT_DIR="$PROJECT_ROOT/src/GroupDocs.Signature.Mcp.Tests"
...
services:
  test-runner:
    ...
    working_dir: /workspace/src/GroupDocs.Signature.Mcp.Tests
    environment:
      DOTNET_NOLOGO: "true"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Signature.Mcp — Docker Test Runner      ║"
    echo "╚════════════════════════════════════════════════════╝"
    echo ""
