...
2. Open Copilot chat.
3. Click the tools / MCP icon — `groupdocs-signature` should appear with
   `sign` and `verify` listed.
...
The [NuGet.org package page](https://www.nuget.org/packages/GroupDocs.Signature.Mcp)
...
```
@workspace sign /docs/contract.pdf with a QR code containing "Reviewed by Alice"
