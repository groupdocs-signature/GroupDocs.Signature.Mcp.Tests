...
{
    // Synthetic fixtures — generated at startup. A blank PDF the engine can sign
    // (text/QR/barcode signatures rasterised onto pages) and a 1×1 JPEG that
    // pre-exists for image-signature search negative paths.
    public const string BlankPdf  = "blank.pdf";
    public const string PlainJpeg = "photo.jpg";

    // Real samples committed under Files/ — copied from the source folder
